                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full min-h-[44px] pl-10 pr-4 py-2.5 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#071A33] text-slate-900"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full min-h-[44px] pl-10 pr-10 py-2.5 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#071A33] text-slate-900"
                      />
                      <button
                        type="button"
            ...
            {internalView === 'register' && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Save itineraries, manage bookings, and access concierge support.
                  </p>
                </div>
                ...
                <form onSubmit={handleRegisterSubmit} className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full min-h-[42px] px-3.5 py-2 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#071A33]"
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex gap-2">
                      <select
                        ...
                        className="w-28 min-h-[42px] py-2 px-2 text-xs bg-white border border-slate-200 rounded-xl"
                      >
                        {COUNTRY_CODES.map((c) => (
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full min-h-[44px] py-3 px-5 rounded-xl bg-[#071A33] hover:bg-[#073B4C] text-white text-sm font-bold shadow-md transition-all cursor-pointer disabled:opacity-50 mt-1"
                  >
                    {isSubmitting ? (
